...
ggplot(combat_year, aes(x = prom_year)) +
  geom_line(aes(y = num_combat, color = "Number of Combat Promotions"), size = 1) +
  geom_line(aes(y = fti * scale_factor, color = "Foreign Threat Index"), size = 1) +  # ✅ no dashed line
  scale_y_continuous(
...
ggplot(loyal_year, aes(x = prom_year)) +
  geom_line(aes(y = num_loyal, color = "Number of Loyal Promotions"), size = 1) +
  geom_line(aes(y = dti * scale_factor, color = "Domestic Threat Index"), size = 1) +
  scale_y_continuous(
